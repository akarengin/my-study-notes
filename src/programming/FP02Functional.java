...
/*                .skip(3)
        ...
        System.out.println(courseList.stream().flatMap(c -> Stream.of(c.split(""))).distinct().collect(Collectors.toList()));
        ...
        System.out.println(courses1.stream().flatMap(course -> courses2.stream().map(course2 -> List.of(course, course2))).collect(Collectors.toList()));
        ...
        System.out.println(courses1.stream().flatMap(course -> courses2.stream().filter(course2 -> course2.length() == course.length())
